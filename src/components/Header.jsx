...
const Header = () => {
  ...
  const notifications = [
    { id: 1, type: 'warning', title: 'High Temperature', message: 'Greenhouse A reached 38°C', time: '2 min ago', icon: 'fa-temperature-high' },
    { id: 2, type: 'info', title: 'Humidity Alert', message: 'Zone B humidity dropped to 40%', time: '1 hour ago', icon: 'fa-droplet' },
    { id: 3, type: 'success', title: 'System Updated', message: 'Firmware v2.0 installed successfully', time: '1 day ago', icon: 'fa-check-circle' },
  ];
      ...
      <header className="h-16 px-4 md:px-8 flex items-center justify-between bg-white/50 backdrop-blur-sm flex-shrink-0 border-b border-gray-100 sticky top-0 z-30">
        ...
        <div className="flex items-center gap-2 md:gap-6">
          ...
          <div className="relative pl-1 md:pl-4 md:border-l border-gray-200" ref={profileRef}>
            ...
            >
              <img 
                src="https://ui-avatars.com/api/?name=Quang+Minh&background=37bb98&color=fff" 
                alt="User" 
              ...
              <div className="hidden md:block text-left">
                <p className="text-sm font-bold text-slate-700 group-hover:text-brand-green transition-colors">Quang Minh</p>
              ...
              <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden animate-[fadeIn_0.2s_ease-out] z-50">
                <div className="p-2 space-y-1">
                  <div className="px-3 py-2 border-b border-gray-50 mb-1">
                      ...
                      <p className="text-sm font-bold text-slate-700 truncate">mphanquang06@gmail.com</p>
                  </div>
                  ...
                  <Link 
                    to="/login" 
                    className="flex items-center gap-3 px-3 py-2 text-sm text-red-500 hover:bg-red-50 hover:text-red-600 rounded-xl transition-colors font-medium"
                  >
