    ...
    const ToggleButton = ({ label, iconClass, isOn, onToggle }) => (
        <div 
            ...
            cursor-pointer select-none ${
                isOn ? 'border-brand-green/30 bg-brand-light/20' : 'border-gray-200 hover:bg-gray-50'
            }`}
            onClick={onToggle}
        >
            <div className="flex justify-between items-start">
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <div className={`w-9 h-5 /* <--- TĂNG KÍCH THƯỚC NÚT GẠT CHÚT XÍU */ rounded-full relative transition-colors duration-300 ${isOn ? 'bg-brand-green/20' : 'bg-gray-200'}`}>
                        <div className={`absolute top-0.5 w-4 h-4 rounded-full shadow-sm transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ${
                            isOn 
